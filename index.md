...
<section class="hero" id="home">
  ...
  <div class="hero-badges">
    <span>Full-Stack Content</span>
    <span>Multichannel Strategy</span>
...
<div class="edu-grid">
  <div class="edu-card">
    ...
    <div class="edu-detail">Sep 2025 – Sep 2026 · United Kingdom</div>
    <div class="edu-detail">Digital Marketing · Digital Cultures & Communication · Global Digital Media</div>
  ...
  <div class="edu-card">
    ...
    <div class="edu-detail">Oct 2021 – Jul 2024 · India</div>
...
<div class="project-card">
  ...
  <p>Analysed American Eagle's 2025 Sydney Sweeney campaign and proposed a new, inclusive, tech-enabled campaign — "Denim for Every Body".</p>
  <div class="tag-row">
...
<div class="leadership-list">
  ...
  <div class="leadership-item">
    ...
    <div class="leadership-org">Department Magazine, University of Delhi</div>
...
<div class="skills-grid">
  <div class="skill-block">
    <h4>Content</h4>
    <ul>
      <li>SEO writing</li><li>UX copy</li><li>Web content</li><li>Blog production</li><li>Social content</li><li>Tone of voice</li>
    </ul>
  </div>
  <div class="skill-block">
    <h4>Strategy</h4>
    <ul>
      <li>Content operations</li><li>Keyword mapping</li><li>Journey design</li><li>Audience insights</li><li>Competitor research</li><li>Brand messaging</li>
    </ul>
  </div>
  <div class="skill-block">
    <h4>Analytics</h4>
    <ul>
      <li>GA4</li><li>GTM</li><li>Looker Studio</li><li>CTR analysis</li><li>Engagement metrics</li><li>Performance QA</li>
    </ul>
  </div>
  <div class="skill-block">
    <h4>Tools</h4>
    <ul>
      <li>HubSpot CMS</li><li>Ahrefs</li><li>SEMrush</li><li>Meta Analytics</li><li>YouTube Studio</li><li>Notion</li>
    </ul>
  </div>
  <div class="skill-block">
    <h4>Collaboration</h4>
    <ul>
      <li>Editorial QA</li><li>Workflow ops</li><li>Cross-team work</li><li>Creative briefs</li><li>Stakeholder comms</li>
    </ul>
  </div>
</div>
</section>
...
<section class="section contact-section" id="contact">
  <div class="contact-inner">
    ...
    <h2 class="contact-heading">Got a project in mind?</h2>
    <p class="contact-sub">I'm open to freelance, contract and full-time opportunities in content marketing and digital strategy.</p>
